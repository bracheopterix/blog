...
function MemoryGame(): JSX.Element {
    ...
    const AllStyles: StyleObj = {
        'market': [{ name: 'fish', src: './MemoryGame/img/market/salmon.png' }, { name: 'cider', src: './MemoryGame/img/market/cider-drink.png' }, { name: 'cheese', src: './MemoryGame/img/market/cheese.png' }, { name: 'bread', src: './MemoryGame/img/market/rolls.png' }, { name: 'vegs', src: './MemoryGame/img/market/vegetable.png' }, { name: 'beer', src: './MemoryGame/img/market/beer.png' }, { name: 'apple3', src: './MemoryGame/img/market/apple(3).png' }, { name: 'bread&fish', src: './MemoryGame/img/market/bread-and-fish.png' }],
